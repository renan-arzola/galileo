<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wf1100.aspx.vb" Inherits="Squilla.wf1100" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>AVL Web Client v1.0 (Desarrollo)</title>
            <table style="width:100%;">
                <tr>
                    <td class="auto-style9">
                        <asp:Image ID="Image3" runat="server" Height="79px" ImageUrl="~/Images/logo-app.png" Width="168px" />
                    </td>
